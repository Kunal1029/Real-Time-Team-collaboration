...
const Common = () => {
  ...
  return (
    <div className="mb-8 mt-5 border m-10 border-gray-200 rounded-lg shadow-xs dark:border-gray-700 md:mb-12 md:grid-cols-2 bg-white dark:bg-gray-800">
      <h3 className="p-2 mt-5 mx-auto text-2xl text-orange-500">
        Welcome {myUser?.name}, Your Current Role is "{currRole}"
      </h3>
      <h5 className=" p-2 mt-5 mx-auto text-xl">
        You can visit all teams in which you are {currRole}
      </h5>
      <ul className="mx-auto ms-5">
        <li>
          - You can remove, add, promote to manager any user in teams when you
          are Admin of that team.
        </li>
        <li>
          - If you switch to any role like Admin, Manager, Member then you can
          see all teams in which your current Role is equals to Team Role.
        </li>
        <li>- This App is in WIP and create new features in future.</li>
      </ul>

      <h4 className="ms-2 mt-20">
        <i>@2025 Real-Time TC APP</i>
      </h4>
